...
#include "CrossingGraphicsModule.h"


namespace ZTNAMESPACE
{
    
    CrossingGraphicsModule::CrossingGraphicsModule()
    {
    ...
    Vertex* CrossingGraphicsModule::AddVertex(POINT point)
    {
    ...
    void CrossingGraphicsModule::DelVertex(Vertex *vertex)
    {
        m_Vertexes.remove(vertex);
    }
    
    Line* CrossingGraphicsModule::AddLine(POINT start, POINT end)
    {
    ...
    void  CrossingGraphicsModule::DelLine(Line *aline)
    {
        m_Lines.remove(aline);
    }
    
    Lamp* CrossingGraphicsModule::AddLamp(POINT center, LampType type)
    {
    ...
    void  CrossingGraphicsModule::DelLamp(Lamp *alamp)
    {
    ...
    ZTBOOL  CrossingGraphicsModule::SetLampLddout(Lamp *alamp, BYTE lddout)
    {
    ...
    LampGroup *CrossingGraphicsModule::findLamp(Lamp *alamp)const
    {
    ...
    Name* CrossingGraphicsModule::AddName(POINT point)
    {
    ...
    void  CrossingGraphicsModule::DelName(Name *aName)
    {
    ...
    LampGroup *CrossingGraphicsModule::GetDefaultGroup()
    {
    ...
    LampGroup *CrossingGraphicsModule::GetGroup(BYTE lddout)
    {
        LampGroup *group = ZTNULL;
...
#pragma mark - coding
    void CrossingGraphicsModule::generateVertexBinary(BYTE *&pByte, INT &length)
    {
    ...
    void CrossingGraphicsModule::generateLinesBinary(BYTE *&pByte, INT &length)
    {
    ...
    void CrossingGraphicsModule::generateLampsBinary(BYTE *&pByte, INT &length)
    {
    ...
    void CrossingGraphicsModule::generateNamesBinary(BYTE *&pByte, INT &length)
    {
